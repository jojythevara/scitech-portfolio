...
I implemented it this way because if I didn't the player wouldn’t be able to access the character selection or the actual game. 

Some challenges I encountered during coding was the fact that if the player clicked ENTER during the gameplay, it would flash back to the start screen. I fixed this by making sure that gameOn would become false when ENTER was pressed while gameOn was already true.
